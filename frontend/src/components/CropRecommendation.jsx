  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 md:p-8 rounded-xl shadow-lg border border-green-50 mt-8 mb-16">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">{t.soilWeatherParams}</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t.nitrogen} <br/><span className="text-xs text-gray-400">0 - 140</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t.phosphorus} <br/><span className="text-xs text-gray-400">5 - 145</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t.potassium} <br/><span className="text-xs text-gray-400">5 - 205</span></label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center"><ThermometerSun size={16} className="mr-1 text-orange-500"/> {t.temperature_label} <span className="ml-1 text-xs text-gray-400">8 - 45</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center"><Droplets size={16} className="mr-1 text-blue-500"/> {t.humidity_label} <span className="ml-1 text-xs text-gray-400">14 - 100</span></label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t.soilPh} <span className="ml-1 text-xs text-gray-400">3.5 - 9.9</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center"><Droplets size={16} className="mr-1 text-blue-400"/> {t.rainfall_label} <span className="ml-1 text-xs text-gray-400">20 - 298</span></label>
          ...
          >
            {isLoading ? t.runningAI : t.getRecommendation}
          </button>
        </form>
          ...
          {!result ? (
            ...
            <div className="w-full space-y-6">
              <div className="bg-white p-5 rounded-lg shadow-sm border border-green-200 text-center">
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">{t.recommendedCrop}</h3>
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm border border-blue-200 text-center">
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">{t.fertilizerSuggestion}</h3>
